...
var view = {
    ...
    displayGuesses: function (shots) {
        var shotsField = document.getElementById("shots");
        shotsField.innerText = shots;

    },

    displayTotalHits: function (hits) {
        var hitsField = document.getElementById("hits");
        hitsField.innerText = hits;
    },
    displayTotalMisses: function (misses) {
        var missesField = document.getElementById("misses");
        missesField.innerText = misses;
    },

    displayTotalShipsSunk: function (shipsSunk) {
        var shipsSunkField = document.getElementById("shipsSunk");
        shipsSunkField.innerText = shipsSunk;
    }
    ...
    fire: function (guess) { // the fire function, receives the player's guess as parameter
        ...
        for (var i = 0; i < this.numShips; i++) {
            ...
            if (index >= 0) {
                ...
                this.totalHits++;
                view.displayTotalHits(this.totalHits);
                ...
                if (this.isSunk(ship)) {
                    ...
                    this.shipsSunk++;
                    view.displayTotalShipsSunk(this.shipsSunk);
                }
        ...
        view.displayTotalMisses(this.totalMisses);
